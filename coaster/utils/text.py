...
__all__ = ['VALID_TAGS', 'unicode_whitespace', 'sanitize_html', 'text_blocks', 'word_count',
    'ulstrip', 'urstrip', 'ustrip', 'deobfuscate_email', 'simplify_text']


#: Python's autogenerated list of Unicode spaces is incorrect, so we maintain our own.
#: Python bug report: https://bugs.python.org/issue10567
#: Reference list: http://jkorpela.fi/chars/spaces.html
unicode_whitespace = (
...
def ulstrip(text):
    """
    Strip Unicode whitespace from the left side of a string
    """
    return text.lstrip(unicode_whitespace)


def urstrip(text):
    """
    Strip Unicode whitespace from the right side of a string
    """
    return text.rstrip(unicode_whitespace)
